package com.example.hariswedira.todofirebase.Utils;
...
import com.example.hariswedira.todofirebase.MainActivity;

public class UserSession {

    public static void save(Context ctx, String name, String value){
        SharedPreferences s = ctx.getSharedPreferences("tokogo",Context.MODE_PRIVATE);
        Editor edt = s.edit();
